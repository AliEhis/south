...
<section class="hero-area">
    <div class="hero-slides owl-carousel">
        ...
        <!-- Single Hero Slide -->
        <div class="single-hero-slide bg-img" style="background-image: url(<?=$homeUrl;?>img/bg-img/hero3.jpg);">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        <div class="hero-slides-content">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <?php
                ...
                {
                    $imageLink = $homeUrl."/uploads/".$product["product_image"];
                    ...
                    echo '<div class="col-12 col-md-6 col-xl-4">
                                <div class="single-featured-property mb-50 wow fadeInUp" data-wow-delay="100ms">
                                    ...
                                    <div class="property-thumb">
                                        ...
                                        <div class="tag">
                                            <span>';
                                            if ($product["product_status"]==ProductStatus::SALE || ProductStatus::RENT){
                                                echo "For ". $product["product_status"];
                                            }
                                            else{
            ...
            echo                        '</span>
                                        ...
                                        <div class="list-price">
                                            <p>N';
                                        echo number_format($product["estimatedPrice"], 2);
            echo                            '</p>
                                   </div>
                                    </div>
                                    <!-- Property Content -->
                                    <div class="property-content">
                                        <h5>';
                                echo        $product["product_country"];
            echo                      '</h5>
                                      <p class="location"><img src="<?=$homeUrl;?>img/icons/location.png" alt="">';
                                    echo   $product["product_state"]," ".$product["product_city"], " ". $product["product_address"];
            echo                            '</p>
                                        <p>';
                    echo                    $product["product_summary"];
                    echo                '</p>
