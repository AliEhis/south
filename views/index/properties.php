                ...
                <div class="advanced-search-form">
                    ...
                    <form action="#" method="post" id="advanceSearch">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-8 col-lg-8 col-xl-5 d-flex">
                                <!-- Space Range -->
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-xl-4">
                <div class="single-featured-property mb-50">
                    ...
                    <!-- Property Content -->
                    <div class="property-content">
                        <h5>Town House in Portharcourt old GRA</h5>
                        <p class="location"><img src="<?=$homeUrl;?>img/icons/location.png" alt="">Upper Road 3411, no.34 CA</p>
                        <p>Integer nec bibendum lacus. Suspendisse dictum enim sit amet libero malesuada.</p>
                        <div class="property-meta-data d-flex align-items-end justify-content-between">
                            <div class="new-tag">
            ...
            <div class="col-12 col-md-6 col-xl-4">
                <div class="single-featured-property mb-50">
                    ...
                    <!-- Property Content -->
                    <div class="property-content">
                        <h5>Town House in Portharcout GRA</h5>
                        <p class="location"><img src="<?=$homeUrl;?>img/icons/location.png" alt="">Upper Road </p>
                        <p>Integer nec bibendum lacus. Suspendisse dictum enim sit amet libero malesuada.</p>
                        <div class="property-meta-data d-flex align-items-end justify-content-between">
                            <div class="new-tag">
                                <img src="<?=$homeUrl;?>img/icons/new.png" alt="">
            ...
            <div class="col-12 col-md-6 col-xl-4">
                <div class="single-featured-property mb-50">
                    <!-- Property Thumbnail -->
                    <div class="property-thumb">
                        <img src="<?=$homeUrl;?>img/bg-img/feature7.jpg" alt="">
            ...
            <div class="col-12 col-md-6 col-xl-4">
                <div class="single-featured-property mb-50">
                    <!-- Property Thumbnail -->
                    <div class="property-thumb">
                        <img src="<?=$homeUrl;?>img/bg-img/feature8.jpg" alt="">
            ...
            <div class="col-12 col-md-6 col-xl-4">
                <div class="single-featured-property mb-50">
                    <!-- Property Thumbnail -->
                    <div class="property-thumb">
                        <img src="<?=$homeUrl;?>img/bg-img/feature9.jpg" alt="">
