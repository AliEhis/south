            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="contact-form">
                        ...
                        ?>
                        <?= $formGroupBegin . $form->field($productModel, 'name')->textInput(['autofocus' => true, "placeholder"=>"Name"]) . $formGroupEnd ?>

                        <?= $formGroupBegin . $form->field($productModel, 'location')->textInput(["placeholder"=>"Choose Location"]) . $formGroupEnd ?>

                        <?= $formGroupBegin . $form->field($productModel, 'email')->textInput(["placeholder"=>"Email"]) . $formGroupEnd ?>

                        <div class="form-group">
                            <?= $form->field($productModel, 'message')->textarea(['rows' => 10, "cols" => 30, "placeholder"=>"Message"]) ?>
                        </div>

                        <?= Html::submitButton('Send Message', ['class' => 'btn south-btn', 'name' => 'submit']) ?>

                        <?php ActiveForm::end(); ?>
                        MySQL - south@localhost
